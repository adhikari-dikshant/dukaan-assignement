...
const Sidebar = () => {
    return (
        <div className=' w-56 bg-primary px-2.5 py-1 flex flex-col sticky top-0 h-screen'>
            <header className='flex space-x-3 px-[8.5px]'>
                ...
                <div className='grow space-y-1'>
                    ...
                    <p className=' text-sm leading-4 text-white/80 underline hover:cursor-pointer w-fit'>Visit store</p>
                </div>
                <svg
